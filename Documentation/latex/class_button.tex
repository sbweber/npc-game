...
\index{Button@{Button}!Button@{Button}}
\subsubsection[{\texorpdfstring{Button(\+S\+D\+L\+\_\+\+Renderer $\ast$ren, const string \&file, int x, int y, int w, int h, T\+T\+F\+\_\+\+Font $\ast$font=\+N\+U\+L\+L, const string \&s="""")}{Button(SDL_Renderer *ren, const string &file, int x, int y, int w, int h, TTF_Font *font=NULL, const string &s="")}}]{\setlength{\rightskip}{0pt plus 5cm}Button\+::\+Button (
...
\item[{int}]{w, }
\item[{int}]{h, }
\item[{T\+T\+F\+\_\+\+Font $\ast$}]{font = {\ttfamily NULL}, }
\item[{const string \&}]{s = {\ttfamily \char`\"{}\char`\"{}}}
\end{DoxyParamCaption}
)}\hypertarget{class_button_a5d841cfdfa9ac8d1db10747ecd94dcdd}{}\label{class_button_a5d841cfdfa9ac8d1db10747ecd94dcdd}
