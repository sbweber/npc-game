// Samuel Weber
  ...
  public:
    ...
    void setSprite(Sprite* sprite, shared_ptr<Tile> tile);
    //!< Sets a Sprite-Tile relationship.
    void setTile(shared_ptr<Tile> tile, Sprite* sprite);
    //!< Sets a Sprite-Tile relationship. Alias for setSprite.
    shared_ptr<Tile> tileClick(SDL_MouseButtonEvent &click, Sprite* sprite);
